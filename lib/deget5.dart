...
class OhmCalculator5 extends StatelessWidget {
  const OhmCalculator5({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          children: [
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: 20,
                            height: 20,
                            color: controller.colorCodes[color]!['color']
                                as Color,
                          ),
            ...
            Obx(() => DropdownButton<String>(
                  value: controller.thirdBand.value,
                  onChanged: (String? newValue) {
                    controller.thirdBand.value = newValue!;
                  },
                  items: controller.colorCodes.keys
                      .map<DropdownMenuItem<String>>((String color) {
                    return DropdownMenuItem<String>(
